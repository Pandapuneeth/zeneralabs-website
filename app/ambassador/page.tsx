...
export const metadata: Metadata = {
  title: "Student Ambassador Program | Earn up to 20–30% Commission — Zenera Labs",
  description:
    "Join the Zenera Labs Student Ambassador Program. Refer clients and earn up to 20–30% commission on every project — no technical work needed. Free to join, paid fast.",
  keywords: [
  ...
  openGraph: {
    ...
    title: "Student Ambassador Program — Earn up to 20–30% Commission | Zenera Labs",
    description:
      "Refer clients to Zenera Labs and earn up to 20–30% commission on every project. No technical work needed. Free to join.",
  ...
  twitter: {
    ...
    description: "Refer clients, earn up to 20–30% commission. No technical work needed.",
