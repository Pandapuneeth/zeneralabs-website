export const AMBASSADOR_TIERS = [
  {
    ...
    label: "20%",
    perks: [
      "20% commission on every closed project",
      "Official ambassador referral link",
      "Payout within 7 days of client payment",
    ],
    highlight: false,
  },
  {
    ...
    label: "25%",
    perks: [
      "25% commission on every closed project",
      "Official ambassador referral link",
      "Priority project status",
      "Exclusive Zenera swag kit",
      "Quarterly ambassador meetups",
      "Priority payout within 3 days of client payment",
    ],
    highlight: true,
  },
  {
    ...
    label: "30%",
    perks: [
      "30% commission on every closed project",
      "Official ambassador referral link",
      "Priority project status",
      "Exclusive Zenera swag kit",
      "Quarterly ambassador meetups",
      "Priority payout within 48 hours of client payment",
      "Your own referral dashboard",
      "Direct line to the founder",
      "Co-branded opportunities",
      "Featured ambassador spotlight on our channels",
      "Annual top-ambassador retreat & rewards",
    ],
    highlight: false,
  },
] as const;
