...
const DynamicIsland = ({
  ...
  return (
    <DynamicIslandContainer className={containerClassName}>
...
const DynamicIslandContent = ({
  ...
  return (
    <motion.div
      id={id}
      className="mx-auto h-0 w-0 items-center justify-center border border-white/20 bg-black text-center text-black transition duration-300 ease-in-out focus-within:bg-neutral-900 hover:shadow-md hover:shadow-black/70 dark:border-white/20 dark:focus-within:bg-black"
      animate={{
