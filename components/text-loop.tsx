...
export function TextLoop({
  ...
  const onWaveEnter = () => tweenRef.current?.pause();
  const onWaveLeave = () => tweenRef.current?.resume();
  const wavePointerProps = pauseOnHover
    ? { onPointerEnter: onWaveEnter, onPointerLeave: onWaveLeave }
    : {};
  ...
  return (
    <div ref={rootRef} className={cn("relative w-full overflow-hidden", className)} style={style}>
      ...
      >
        ...
        <text className="select-none" style={textStyle} fill={color} dominantBaseline="central" aria-hidden="true" {...wavePointerProps}>
